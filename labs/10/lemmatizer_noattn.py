...
class Network(tf.keras.Model):
    ...
    def call(self, inputs, targets=None):
        ...
        source_states = self.source_rnn(embed)
    ...
    def train_step(self, data):
        ...
        y_targets = tf.concat([y_targets, tf.fill([y_targets.bounding_shape(0), 1], tf.constant(MorphoDataset.Factor.EOW, tf.int64))], axis=-1)
